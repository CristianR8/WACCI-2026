...
export default function SignUpPage() {
 ...
 <div className="contact-wrapper border p-14 relative z-30 bg-white border-gray-100">
 ...
 <button className="bg-gray-100 w-full h-12 justify-center transition font-normal text-sm hover:bg-gray-200 rounded-full text-gray-700 hover:text-gray-800 flex items-center gap-3 px-8 py-2.5">
 <svg
 width="21"
 height="20"
 viewBox="0 0 21 20"
 ...
 <circle cx="380.335" cy="380.335" r="179.665" fill="#3f879a" />
 </g>
 <g opacity="0.7" filter="url(#filter1_f_9248_10254)">
 <circle cx="549.665" cy="380.335" r="179.665" fill="#073A4B" />
 </g>
 <defs>
 <filter
