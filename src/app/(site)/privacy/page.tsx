...
export default function PrivacyPage() {
 ...
 Updated
 <span className="text-gray-800 ml-1 inline-block ">
 15 Jan, 2028
 </span>
 </p>
 ...
 <div className="mb-6">
 <p className="text-gray-500 font-normal leading-6 mb-6">
 ...
 <p className="text-gray-500 font-normal leading-6 mb-4">
 ...
 <li className="text-gray-500 font-normal leading-6 mb-4">
