...
export default function GeneratorHeader({
 ...
 type="button"
 className="inline-flex xl:hidden items-center hover:bg-gray-100 hover:text-gray-800 text-gray-500 justify-center border border-gray-200 rounded-full size-11"
 >
