...
export default function GeneratorInput({
 ...
 <div
 className="bg-white/15 border border-[#E4E7EC] rounded-3xl backdrop-blur-[10px] shadow-theme-md overflow-hidden aria-disabled:opacity-70 aria-disabled:pointer-events-none"
 ...
 className=" focus:outline-0 placeholder:text-sm resize-none max-h-44 leading-5 w-full custom-scrollbar pb-8"
 required
 rows={1}
 />
 </div>
 ...
 type="submit"
 ref={submitButtonRef}
 className="size-10 flex bg-[#1D2939] transition items-center justify-center rounded-full text-white"
 disabled={!value?.trim()}
 >
