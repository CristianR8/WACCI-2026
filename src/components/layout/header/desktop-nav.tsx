...
export default function DesktopNav() {
 ...
 href={item.href}
 className={cn(
 'text-gray-500 text-sm px-4 py-1.5 rounded-full hover:text-primary-500 font-medium',
 {
 'bg-white font-medium text-gray-800 shadow-xs':
 pathname === item.href,
 }
 )}
 >
 ...
 className={cn(
 'text-gray-500 hover:text-primary-500 group text-sm inline-flex gap-1 items-center px-4 py-1.5 font-medium rounded-full',
 {
 'bg-white font-medium text-gray-800 shadow-xs':
 ...
 className="absolute right-0 w-[266px] bg-white rounded-2xl shadow-theme-lg border border-gray-100 p-3 z-50"
 >
