...
export function Modal({
 ...
 <div
 className={cn(
 'bg-white rounded-3xl text-left overflow-hidden sm:w-[590px] transform transition-all p-5 sm:p-12 relative',
 className?.modal
 )}
 >
 ...
 onClick={onClose}
 type="button"
 className="bg-gray-100 hover:bg-gray-200 rounded-full size-9 inline-flex items-center justify-center text-gray-500"
 >
 ...
 <h3 className="text-[30px] mb-2 leading-[38px] font-bold text-gray-800 ">
 {title}
 </h3>
 {description && (
