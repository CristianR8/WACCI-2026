...
export function Pagination({
 ...
 className="px-3.5 py-2 rounded-lg shadow-xs border border-[#D0D5DD] hover:bg-gray-200/50 disabled:opacity-50 disabled:pointer-events-none"
 >
 Previous
 </button>
 </li>
...
function PaginationEllipsis() {
 return (
 <button className="size-10 rounded-lg shrink-0 hover:bg-gray-200/50 cursor-default">
 ...
 </button>
 );
}
